...
As part of [the recent site relaunch](./welcome-to-xrpl-org.md), the XRP Ledger Dev Portal has an updated version of the [WebSocket API Tool](https://xrpl.org/websocket-api-tool.html). This tool lets you communicate directly with `rippled` servers, which power the XRP Ledger network. Among several of the improvements in this new version of the tool is that you can choose which servers to connect to, including the public servers Ripple runs, servers in the XRP Test Net, or your own server running locally on your own computer.
...
![Server Selector button showing an active connection to the Test Net](../img/wstool-server-selector.png)
...
![Permalink button](../img/wstool-permalink-button.png)
...
![curl syntax button](../img/wstool-curl-syntax-button.png)
...
![Keep last setting, pause subscription button, and clear history button](../img/wstool-message-history-management.png)
