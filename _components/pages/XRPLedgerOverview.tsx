...
export default function XRPLedgerOverview() {
  ...
  return (
    <div className="overflow-hidden styled-page page-xrpl-overview">
      ...
      <section className="py-26 text-center">
        <div className="col-lg-5 mx-auto text-center">
          <div className="d-flex flex-column-reverse">
            ...
            <h6 className="eyebrow mb-3 title">XRPL | XRP Ledger Overview</h6>
          </div>
        </div>
      </section>
        ...
        <div className="card-grid card-grid-2xN">
          <div className="col">
            ...
            <p className="mb-4">
              ...
              manages the ledger. The global XRP Ledger community—a diverse set
              of software engineers, server operators, users, and
              businesses—maintains the ledger.
            </p>
          ...
          <div className="col">
            ...
            <div className="text-center d-lg-none">
              <a
                className="btn btn-primary btn-arrow mt-5 mb-4"
                href="docs.html"
              >
                Read Technical Docs
              </a>{" "}
        ...
        <div className="card-grid card-grid-2xN">
          <div className="col">
            ...
            <p className="mb-4">
              ...
              <a href="run-a-rippled-validator.html">validators</a> come to an
              agreement on the order and outcome of XRP transactions every 3-5
              seconds.
            </p>
            <p className="mb-6">
              All servers in the network process each transaction according to
              the same rules, and any transaction that follows the protocol is
              confirmed right away. All transactions are public, with strong
              cryptography to guarantee the integrity of the system.
            </p>
            <p className="mb-0">
              ...
              are active on the ledger, operated by universities, exchanges,
              businesses, and individuals. Additionally, the consensus protocol
              ensures the blockchain becomes more decentralized over time as the
              validator pool grows.
            </p>
          </div>
      ...
      <section className="container-new py-26">
        <div className="col-md-6 offset-md-3 p-6-sm p-10-until-sm br-8 cta-card">
          <img
            src={prefix + "/img/backgrounds/cta-xrpl-overview-green.svg"}
            className="cta cta-bottom-right"
          />
          <div className="z-index-1 position-relative">
            <h2 className="h4 mb-10-until-sm mb-8-sm">A Greener Blockchain</h2>
            <p className="mb-10">
              Unlike most other blockchains, the XRP Ledger does not need
              mining, so <a href="impact.html">no energy is wasted</a> in the
              transaction process. Learn how this compares to other platforms
              with our{" "}
              <a href="carbon-calculator.html">Green Currency Calculator</a>.
            </p>
      ...
      <section className="container-new py-26">
        <div className="card-grid card-grid-2xN">
          <div className="col">
            ...
            <p className="mb-4">
              The ledger’s unique properties, such as its fast and efficient
              consensus algorithm and censorship-resistant transaction
              processing, are leveraged by thousands of developers.
            </p>
            <p className="mb-10">
              With the XRPL, these developers are building innovative projects
              and applications across blockchain use cases including
              tokenization of assets, online gaming, asset custody, NFTs, and
              DeFi.
            </p>
          ...
          <div className="col mb-0">
            ...
            <p className="mb-4">
              While XRPL is the choice of developers who don’t want to sacrifice
              security or performance and who want to build on the greenest
              blockchain, that’s only the beginning.
            </p>
            <p className="mb-0">
              As a community-led blockchain, XRPL’s vision is also a community
              effort.{" "}
              <a href="https://xrplf.org/" target="_blank">
                The XRPL Foundation
              </a>{" "}
              is currently collaborating with community members to define a
              shared vision statement. Stay tuned for more on this effort—we
        ...
        <div className="row row-cols-1 row-cols-lg-3 d-flex justify-content-between w-100 mx-0 mx-md-n3 mt-md-5">
          ...
          <div className="px-md-3 pt-5 pt-md-0">
            ...
            >
              <img
                src={
                  prefix + "/img/overview/video_explainer_sustainability@2x.png"
                }
      ...
      <section className="container-new py-26">
        <div className="col-md-6 offset-md-3 p-6-sm p-10-until-sm br-8 cta-card">
          <img
            src={prefix + "/img/backgrounds/cta-xrpl-overview-orange.svg"}
            className="cta cta-bottom-right"
          />
          <div className="z-index-1 position-relative">
            ...
            <p className="mb-10">
              XRP Ledger’s innovation relies on the shared community experience
              of builders like you. If you’re ready to start your next big
              blockchain project, explore the XRPL now and consider applying for
              an XRPL Grant.
            </p>
            <a
              className="btn btn-primary btn-arrow"
