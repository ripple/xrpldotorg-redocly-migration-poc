...
import coCash from "../../static/js/calculator/co2-cash.json";
import coCredit from "../../static/js/calculator/co2-credit.json";
import coCrypto from "../../static/js/calculator/co2-credit.json";
import gasCrypto from "../../static/js/calculator/gas-crypto.json";
import gasCash from "../../static/js/calculator/gas-cash.json";
import gasCredit from "../../static/js/calculator/gas-credit.json";
          ...
          >
            ...
            <section className="min-vh100 bb-gray section3 clearfix">
              ...
              <p className="calculator-section-description">
                ...
                million gallons of gas. Measure the environmental impact between
                currencies in relation to the amount of gas they would consume
                in the real-world.
              </p>
              ...
              <ul className="d-sm-flex  p-0">
                ...
                <li className="d-output d-cash" data-comp="gas" data-type="pap">
                  <p className="h6 mt-3 mb-1">Cash</p>
