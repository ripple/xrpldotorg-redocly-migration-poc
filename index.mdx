...
<Jumbotron>
  ...
  <H1>XRP Ledger for Developers</H1>
  <H2>A developer portal with documentation, API help, and tutorials for the XRP Ledger.</H2>
  <Flex p={20} justifyContent="center">
    {/* <Button size="xlarge" to="https://app.redoc.ly">
      Redocly app
    </Button> */}
     <Button variant="outlined" size="xlarge" to="developer-portal/docs/index.md">
      Get started
    </Button>
