...
- The `rippled` server is already installed with online deletion enabled. See [Install rippled](../installation/index.mdx) and [online deletion](../../ledger-history/online-deletion.md)
...
- Your server has enough disk space to store your chosen amount of history in its ledger store.
    ...
    See [Capacity Planning](../installation/capacity-planning.md) for details of how much storage is required for different configurations.
