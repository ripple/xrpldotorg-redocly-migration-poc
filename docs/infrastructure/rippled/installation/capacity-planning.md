...
For instructions on how to change the amount of history you keep, see [Configure Online Deletion](../configuration/configure-online-deletion.md).
...
- **XRPL Infrastructure:**
    - [Configure rippled](../../rippled/configuration/index.mdx)
        - [Configure Online Deletion](../configuration/configure-online-deletion.md) - Adjust how many historical ledger versions your server should keep at a time.
