...
import { XRPLoader } from '../../../_components/XRPLoader.tsx';
const STEPS = [ 'Generate', 'Connect', 'Send AccountSet', 'Wait', 'Confirm Settings'];

<!-- Source for this specific tutorial's interactive bits: -->
<Helmet>
  <script src="/static/js/interactive-tutorial.js"></script>
  <script src="/static/js/tutorials/enable-no-freeze.js"></script>
</Helmet>
