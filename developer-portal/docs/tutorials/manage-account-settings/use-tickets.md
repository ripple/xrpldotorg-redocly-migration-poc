...
<!--TODO: change to Testnet eventually. NOTE, Testnet is a few days behind Mainnet in getting the amendment one enabled -->
...
To transact on the XRP Ledger, you need an address and secret key, and some XRP. For development purposes, you can get these on the [Devnet](parallel-networks.html) using the following interface:
...
<button id="generate-creds-button" class="btn btn-primary" data-fauceturl="https://faucet.devnet.rippletest.net/accounts">Get Devnet credentials</button>
...
<button id="connect-button" class="btn btn-primary" data-wsurl="wss://s.devnet.rippletest.net:51233">Connect to Devnet</button>
<div>
...
<div class="interactive-block" id="interactive-check_sequence">
  <div class="interactive-block-inner">
    <div class="breadcrumbs-wrap">
      <ul class="breadcrumb tutorial-step-crumbs" id="bc-ul-check_sequence" data-steplabel="Check Sequence" data-stepid="check_sequence">
      </ul><!--/.breadcrumb.tutorial-step-crumbs-->
    </div><!--/.breadcrumbs-wrap-->
  <div class="interactive-block-ui">
...
<div class="interactive-block" id="interactive-prepare_sign">
  <div class="interactive-block-inner">
    <div class="breadcrumbs-wrap">
      <ul class="breadcrumb tutorial-step-crumbs" id="bc-ul-prepare_sign" data-steplabel="Prepare & Sign" data-stepid="prepare_sign">
      </ul><!--/.breadcrumb.tutorial-step-crumbs-->
    </div><!--/.breadcrumbs-wrap-->
  <div class="interactive-block-ui">
...
<table class="wait-step" data-explorerurl="https://devnet.xrpl.org">
  <tr>
...
<div class="interactive-block" id="interactive-intermission">
  <div class="interactive-block-inner">
    <div class="breadcrumbs-wrap">
      <ul class="breadcrumb tutorial-step-crumbs" id="bc-ul-intermission" data-steplabel="Intermission" data-stepid="intermission">
      </ul><!--/.breadcrumb.tutorial-step-crumbs-->
    </div><!--/.breadcrumbs-wrap-->
  <div class="interactive-block-ui">
...
<div class="interactive-block" id="interactive-check_tickets">
  <div class="interactive-block-inner">
    <div class="breadcrumbs-wrap">
      <ul class="breadcrumb tutorial-step-crumbs" id="bc-ul-check_tickets" data-steplabel="Check Tickets" data-stepid="check_tickets">
      </ul><!--/.breadcrumb.tutorial-step-crumbs-->
    </div><!--/.breadcrumbs-wrap-->
  <div class="interactive-block-ui">
...
<div class="interactive-block" id="interactive-prepare_ticketed_tx">
  <div class="interactive-block-inner">
    <div class="breadcrumbs-wrap">
      <ul class="breadcrumb tutorial-step-crumbs" id="bc-ul-prepare_ticketed_tx" data-steplabel="Prepare Ticketed Tx" data-stepid="prepare_ticketed_tx">
      </ul><!--/.breadcrumb.tutorial-step-crumbs-->
    </div><!--/.breadcrumbs-wrap-->
  <div class="interactive-block-ui">
...
<div class="interactive-block" id="interactive-submit_ticketed_tx">
  <div class="interactive-block-inner">
    <div class="breadcrumbs-wrap">
      <ul class="breadcrumb tutorial-step-crumbs" id="bc-ul-submit_ticketed_tx" data-steplabel="Submit Ticketed Tx" data-stepid="submit_ticketed_tx">
      </ul><!--/.breadcrumb.tutorial-step-crumbs-->
    </div><!--/.breadcrumbs-wrap-->
  <div class="interactive-block-ui">
