...
The `peer_reservations_del` method removes a specific [peer reservation][], if one exists. [New in: rippled 1.4.0][]

_The `peer_reservations_del` method is an [admin method](admin-rippled-methods.html) that cannot be run by unprivileged users._
