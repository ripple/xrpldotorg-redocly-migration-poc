...
The `peer_reservations_list` method lists [peer reservations][]. [New in: rippled 1.4.0][]

_The `peer_reservations_list` method is an [admin method](admin-rippled-methods.html) that cannot be run by unprivileged users._
