...
In addition to errors that can occur for all transactions, AccountDelete transactions can result in the following [transaction result codes](transaction-results.html):
